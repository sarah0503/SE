...
public class UserLineActivity extends AppCompatActivity {
    ...
    private void getData() { //임의 데이터
        ...
        List<String> stop1List = Arrays.asList("경유지1", "경유지2", "경유지3", "경유지4", "경유지5", "경유지6", "경유지7",
                "경유지8", "경유지9", "경유지10", "경유지11", "경유지12", "경유지13", "경유지14");

        List<String> stop2List = Arrays.asList("경유지1", "경유지2", "경유지3", "경유지4", "경유지5", "경유지6", "경유지7",
                "경유지8", "경유지9", "경유지10", "경유지11", "경유지12", "경유지13", "경유지14");

        List<String> stop3List = Arrays.asList("경유지1", "경유지2", "경유지3", "경유지4", "경유지5", "경유지6", "경유지7",
                "경유지8", "경유지9", "경유지10", "경유지11", "경유지12", "경유지13", "경유지14");
